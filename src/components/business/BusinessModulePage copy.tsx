...
const MODULE_TABS: Record<BusinessModuleKey, ModuleTab[]> = {
  crm: [
    { id: 'pipeline', label: 'Pipeline', sectionIds: ['operations'], default: true },
  ...
  sales: [
    ...
    },
    {
      id: 'pos-sales',
      label: 'POS Sales',
      sectionIds: ['sales-pos', 'sales-payments', 'sales-cash-drawer', 'pos-restaurant', 'rental-desk', 'sales-channels', 'salesperson-tracking'],
    },
  ],
  finance: [
    { id: 'operations', label: 'Operations', sectionIds: ['operations'], default: true },
    { id: 'approval-flows', label: 'Approval Flows', sectionIds: ['workflows', 'compliance'] },
    { id: 'reference', label: 'Reference', sectionIds: ['core-objects', 'features'] },
  ],
  hr: [
  ...
  inventory: [
    ...
    { id: 'counters', label: 'Counters', sectionIds: ['stock-types'] },
    { id: 'products', label: 'Products', sectionIds: ['product-management', 'inventory-structure'] },
  ],
  projects: [
    { id: 'execution', label: 'Execution', sectionIds: ['operations'], default: true },
    { id: 'workflows', label: 'Workflows', sectionIds: ['workflows', 'governance'] },
    { id: 'reference', label: 'Reference', sectionIds: ['core-objects', 'features'] },
  ],
  procurement: [
    { id: 'procurement', label: 'Procurement', sectionIds: ['operations'], default: true },
    { id: 'workflows', label: 'Workflows', sectionIds: ['workflows', 'governance'] },
    { id: 'reference', label: 'Reference', sectionIds: ['core-objects', 'features'] },
  ],
  support: [
    { id: 'tickets', label: 'Tickets', sectionIds: ['operations'], default: true },
    { id: 'sla', label: 'SLA & Escalations', sectionIds: ['workflows', 'governance'] },
    { id: 'reference', label: 'Reference', sectionIds: ['core-objects', 'features'] },
  ],
  analytics: [
