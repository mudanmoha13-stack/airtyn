...
export const BUSINESS_MODULE_SPECS: BusinessModuleSpec[] = [
  ...
  },
  {
    ...
    icon: Wallet,
    summary:
      'Run the full employee lifecycle across workforce planning, recruitment, onboarding, employee administration, time, payroll prep, performance, learning, assets, compliance, and offboarding in one connected People Operations workspace.',
    coreObjects: ['Employees', 'Org Units', 'Candidates', 'Onboarding Plans', 'Contracts', 'Attendance', 'Shifts', 'Leave', 'Payroll Runs', 'Claims', 'Assets', 'Offboarding Cases'],
    features: [
      'Employee master with profile, emergency, identity, tax, bank, branch, manager, and lifecycle details',
      'Organization structure with legal entities, branches, departments, teams, positions, reporting lines, and headcount planning',
      'Recruitment and hiring with requisitions, candidates, interviews, offers, approvals, and talent pipeline stages',
      'Onboarding workflows with templates, IT/admin tasks, provisioning, buddy assignment, induction, and probation setup',
      'Contracts, attendance, shifts, leave, payroll preparation, expenses, travel, performance, goals, learning, certifications, asset assignment, compliance, incidents, grievance, and offboarding records',
      'Attendance correction, overtime, requisition, interview, offer, self-service, manager self-service, analytics, workflow, and automation coverage',
    ],
    workflows: [
      'Hiring, onboarding, and probation workflows',
      'Attendance, shift, leave, expense, travel, and payroll approval chains',
      'Performance, goals, learning, asset return, compliance, incident, disciplinary, offboarding, self-service, manager action, analytics, and workflow lifecycles',
    ],
    governance: [
      'Role-based access for compensation, compliance, and sensitive employee data',
      'Approval chains for hiring, payroll, claims, travel, position changes, and separations',
      'Audit visibility across employee lifecycle, attendance edits, and document/status changes',
    ],
    stats: [
      { label: 'Employees', value: '412', delta: '28 departments and branches covered' },
      { label: 'Open approvals', value: '34', delta: 'Leave, payroll, claims, travel, onboarding, offboarding' },
      { label: 'Active hiring', value: '26', delta: 'Across requisitions and candidate stages' },
      { label: 'Compliance watch', value: '11', delta: 'Docs, incidents, and lifecycle actions due' },
    ],
    records: [
      { title: 'Payroll Run May-1', subtitle: 'Gross payroll ready for finance approval', meta: '$842,114', status: 'Pending approval' },
      { title: 'Onboarding Wave', subtitle: 'New hires awaiting provisioning and induction tasks', meta: '8 employees', status: 'In progress' },
  ...
  },
  {
    ...
    eyebrow: 'Restaurant catalog and stock control',
    route: '/business/inventory',
    icon: Package2,
    summary:
      'Run the restaurant product master, menus, modifiers, recipes, kitchen-linked inventory, pricing, availability, replenishment, and waste control from one connected workspace.',
    coreObjects: [
      'Product Master',
      'Product Variants',
      'SKUs',
    ...
    stats: [
      { label: 'Tracked menu SKUs', value: '214', delta: 'Finished, raw, prep, combo, service' },
      { label: 'Recipe coverage', value: '82%', delta: 'Sellable items linked to ingredient usage' },
      { label: 'Waste watch', value: '$1.8k', delta: 'Current logged variance impact' },
      { label: 'Replenishment queue', value: '17', delta: 'Low-stock suggestions awaiting action' },
    ],
    records: [
      { title: 'Breakfast Menu', subtitle: 'Morning menu with time-based visibility and price overrides', meta: '6AM–11AM', status: 'Active' },
      { title: 'Burger Recipe Set', subtitle: 'Finished product linked to buns, patty, cheese, and sauce usage', meta: 'Kitchen BOM', status: 'Active' },
      { title: 'Tomato Replenishment', subtitle: 'Low-stock trigger generated for branch store', meta: 'Suggested qty 25', status: 'Pending' },
    ],
  },
  {
    key: 'projects',
