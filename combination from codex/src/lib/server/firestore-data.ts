...
export const col = {
  ...
  coreInviteTokens: 'core_invite_tokens',
  ...
  bizMenus: 'biz_menus',
  bizMenuItems: 'biz_menu_items',
  bizModifiers: 'biz_modifiers',
  bizModifierOptions: 'biz_modifier_options',
  bizRecipes: 'biz_recipes',
  bizRecipeComponents: 'biz_recipe_components',
  bizProductPricing: 'biz_product_pricing',
  bizProductAvailability: 'biz_product_availability',
  bizWasteLogs: 'biz_waste_logs',
  bizUoms: 'biz_uoms',
  ...
  bizRestaurantReplenishment: 'biz_restaurant_replenishment',
  bizRestaurantLaborCost: 'biz_restaurant_labor_cost',
  bizAccountingJournals: 'biz_accounting_journals',
  ...
  bizHrOrgUnits: 'biz_hr_org_units',
  bizHrOnboarding: 'biz_hr_onboarding',
  bizHrShifts: 'biz_hr_shifts',
  bizHrAttendanceCorrections: 'biz_hr_attendance_corrections',
  bizHrOvertime: 'biz_hr_overtime',
  bizHrExpenses: 'biz_hr_expenses',
  bizHrTravel: 'biz_hr_travel',
  bizHrRequisitions: 'biz_hr_requisitions',
  bizHrInterviews: 'biz_hr_interviews',
  bizHrOffers: 'biz_hr_offers',
  bizHrPerformance: 'biz_hr_performance',
  bizHrGoals: 'biz_hr_goals',
  bizHrLearning: 'biz_hr_learning',
  bizHrCertifications: 'biz_hr_certifications',
  bizHrAssets: 'biz_hr_assets',
  bizHrDocuments: 'biz_hr_documents',
  bizHrIncidents: 'biz_hr_incidents',
  bizHrDiscipline: 'biz_hr_discipline',
  bizHrOffboarding: 'biz_hr_offboarding',
