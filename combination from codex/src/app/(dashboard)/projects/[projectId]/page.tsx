...
const ProjectKanban = ({ projectId }: { projectId: string }) => {
  ...
  const [projectStatus, setProjectStatus] = useState<'active' | 'archived' | 'completed' | 'on_hold'>(project?.status ?? 'active');
            ...
            <DialogContent>
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-2">
                    <Label>Status</Label>
                    <Select value={projectStatus} onValueChange={(v: 'active' | 'archived' | 'completed' | 'on_hold') => setProjectStatus(v)}>
                      <SelectTrigger><SelectValue /></SelectTrigger>
                      <SelectContent>
